spec_Dict = {
    "overwatch": ["not a big fan of shooters, but the story behind overwatch is a beautiful one so it's an exception.",
                  "who is your favorite hero?", "i think mercy is the best hero, i love keeping my teammates alive.",
    ...
    "rainbow 6 siege": ["rainbow 6 siege is all right, I'd like it more if it wasn't a shooter.",
                        "what is your favorite mode to play on?",
                        "I gotta say mine is bomb. it's the bomb.", "who is your favorite operator?",
                        "rook is the best. he's simple and straightforward even though i'm not good nor a fan of shooters.",
                        "first person shooter"],
    "dota": ["dota is one of the original moba games, it definitely started a new trend in gaming.",
             "who is your favorite champion?",
             "for me: there's so many champions, i can't pick just one as a favorite!",
             "what is your favorite mode to play on?",
    ...
    "super smash brothers": [
        ...
        "magicant has got to be my fav, it's just a pleasant stage to look at.", "action"],
    "pokemon": [
    ...
    "undertale": ["I love making friends with all the monsters in the underground!",
                  ...
                  "role playing game"],
    "persona 5":["persona five is a fantastic bled of story and action, i am truly invested the relationships built with other characters.","what persona do you most enjoy?","shiki-ou.ji is my favorite because of how good his defensive typings are","which boss is your favorite?","shido is my favorite boss because it is what the game has been building up to.","role playing game"],
    ...
    "hearthstone":["i like the stratagizing mechanics of hearthstone.","which class do you usually play?","my favorite is the mage class, because i like using the spells and the fireballs.","what mode do you usually play with?","arena is my favorite, it is fun to test your skills against other players without having to collect the cards.","rogue like"],
...
descripSpec_Dict = {
    ...
    "persona 5": "persona 5 is an intricate role playing game based, which has complex storylines, incredible graphics and challanging bosses.",
    ...
    "skyrim":"skyrim is a classic role playing game with a dragon oriented storyline.",
        ...
        "persona 5": "persona 5 is a role playing game with unique art and a fantastic storyline."
  }
...
dict_genre = {
    ...
    "shooter": "shooter games are too violent for me in general.",
    ...
    "horror": "horror games are pretty brutal. not my cup of tea, either.",
...
personaBoss_dict = {
    ...
    "madarame":"i like how madarametransfered from painting form to human form.",
    "kaneshiro":"i like how you could throw items in from of kaneshiro to distract him.",
    "okumura":"i like how impactful futaba's transformation was when fightingokumura, it made for an interesting narrative.",
    "shido":"i like how you finally get closure in beatingshido since it's what the game has been building to.",
...
"generator defense":"generator defense is fun, i love being able to covenent!",
"1 flag ctf":"1 flag ctf is hard, carying the flag is so stressful!",
"stockpile":"i always feel like someone will steal my flag in stockpile, so i defend more than i attack.",
"oddball":"oddball is a classic, i appreicate that it appears in every game!",
"crazy king":"crazy king is a cool vesion of king of the hill.",
"3 plots":"3 plots is a cool vesion of king of the hill, i had never thought about having three hills to capture at the same time!",
"slayer":"slayer is a classic, i appreicate that it appears in every game!",
...
fireVersions_dict = {
    ...
    "genealogy of the holy war":"genealogy of the holy warwas fun as you worked earth dragon loptyr.",
    ...
    "shadow dragon and the blade of light":"shadow dragon and the blade of lightis so much fun because you get the origin of marth as he developes into marth the hero-king.",
